...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-8662cc387fabc912"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-8662cc387fabc912",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-8662cc387fabc912",
        "url": "https://en.wikipedia.org/wiki/Brocard%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Brocard's conjecture : there are always at least $4$ prime numbers between consecutive squares of prime numbers, aside from $2^{2}$ and $3^{2}$ .",
      "version": 1
    },
    "title": "Brocard's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "351912762857cbd9c5dff14812d2f4289f02cf1efdb67b2a5dbb8eaf3876af43"
}
```
